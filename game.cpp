...
{
    if(xMouse>100&&xMouse<350&&yMouse>400&&yMouse<502)
    {
            return true;
          }
return false;
...
{
    if(xMouse>100&&xMouse<350&&yMouse>500&&yMouse<602)
    {
            return true;
          }
return false;
...
{
     if(xMouse>157&&xMouse<200&&yMouse>431&&yMouse<442)
    {
            return true;
          }
return false;
...
{
     if(xMouse>247&&xMouse<281&&yMouse>431&&yMouse<442)
    {
            return true;
          }
return false;
...
{   getMousePos(xMouse,yMouse);
    ...
    else if(status==Menu)
    {
      ...
      graphics.renderTexture(graphics.pic[UNSELECT_PLAY],110,420);
      graphics.renderTexture(graphics.pic[TITLE],15,90);
      graphics.renderTexture(graphics.pic[UNSELECT_EXIT],110,500);
      if(menuToStart(xMouse,yMouse)) graphics.renderTexture(graphics.pic[PLAY_BUTTON],106,420);
      if(menuToExit(xMouse,yMouse)) graphics.renderTexture(graphics.pic[EXIT_BUTTON],110,500);
    }
    else if(status==GameOver)
    {
         graphics.renderTexture(graphics.pic[GAME_OVER],0,0);
